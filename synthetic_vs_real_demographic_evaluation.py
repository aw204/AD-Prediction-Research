...
Real vs synthetic demographic fidelity for TabDDPM. Create four plots:
  tab_ddpm_continuous_feature.png    KDE overlays, age and education
  tab_ddpm_qq_plots.png              Q-Q plots, age and education
  tab_ddpm_categorical_bar.png       diagnostic class proportions
  tab_ddpm_gender_by_diagnostic.png  gender composition within each class
"""
...
def generate_eval_plots():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, "tab_ddpm_continuous_feature.png"), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, "tab_ddpm_categorical_bar.png"), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, "tab_ddpm_qq_plots.png"), dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, "tab_ddpm_gender_by_diagnostic.png"), dpi=300, bbox_inches='tight')
    plt.close()
